    ...
    <div className="page-stack">
      ...
      <section className="content-card">
        <div className="section-header">
          <div>
            <h2>기준 시점</h2>
            <p>인구·세대수 스냅샷 기준 시점은 2026년 2월이며, 선거 기준 시점은 2025년 제21대 대통령선거, 2024년 제22대 국회의원선거 지역구·비례대표, 2022년 제20대 대통령선거, 2022년 제8회 전국동시지방선거 서울시장·구청장·서울시교육감·서울시의원·구의원·비례대표 결과입니다.</p>
          </div>
        </div>
